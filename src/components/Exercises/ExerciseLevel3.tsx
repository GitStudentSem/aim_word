						...
						{options.map((option, index) => (
							<button
								...
								className={`${styles.optionButton} ${
									...
									hasAnswered && selectedAnswer === option && option !== word.translation.text
										? styles.incorrect
										: ""
								}`}
					...
					<div className={styles.result}>
						{selectedAnswer === word.translation.text ? (
							<div className={styles.correct}>
								<p>Правильно! "{word.text}" = "{word.translation.text}"</p>
							</div>
						) : (
							<div className={styles.incorrect}>
								<p>Неправильно! Правильный ответ: "{word.translation.text}"</p>
							</div>
						)}
						<button
